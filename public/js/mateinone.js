...
'8/3K1k2/8/8/8/2Q5/1B6/8 w - -',
  ...
  game = {
    ...
    boardId: 'board',
    historyId: 'history',
    alltimehistoryId: 'alltimehistory',
    $start: $('#start'),
    $timer: $('#timer'),
    $score: $('#score'),
    $board: null,
    ...
    validateCheckMate: function validateCheckMate (newPos, oldPos) {
        //console.log('newpos',typeof(newPos),'oldpos',typeof(oldPos));
    ...
    init: function init () {
      ...
      this.$alltimehistory = $('#' + this.alltimehistoryId);
      ...
      this.countdown(function during (seconds) {
        ...
        this.$alltimehistory.removeClass('hidden');
  ...
  game.$start.on('click', function start () {
    //game.$history.addClass('hidden');
    document.getElementById('history').classList.add('hidden');
    document.getElementById('alltimehistory').classList.add('hidden');
    game.init();
  });
